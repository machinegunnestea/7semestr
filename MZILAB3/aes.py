...
# Предоставленные S-блоки
S_BOX = [
    0x63, 0x09, 0x77, 0x7B, 0xF2, 0x6B, 0x6F, 0xC5, 0x30, 0x01, 0x67, 0x2B, 0xFE, 0xD7, 0xAB, 0x76,
...
def encrypt(input_file, key_file, output_file):
    ...
    # Применение S-блока перед шифрованием
    data = apply_s_box(data)
...
def decrypt(input_file, key_file, output_file):
    ...
    # Применение обратного S-блока после дешифрования
    data = apply_s_box(data)
...
# Шифрование
encrypt(input_file, key_file, encrypted_file)
